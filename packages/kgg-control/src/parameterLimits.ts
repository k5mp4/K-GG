...
export const PARAMETER_LIMITS = {
  ...
  'diffuse.halftoneGrain': { min: 2, max: 64, step: 1 },
  'diffuse.asciiGrain': { min: 4, max: 64, step: 1 },
  ...
  'flow.seed': { min: 0, max: 9999, step: 1, integer: true },
  'flow.particleCount': { min: 10000, max: 500000, step: 1000, integer: true },
  'flow.curlScale': { min: 0.1, max: 20, step: 0.1 },
  'flow.curlStrength': { min: 0, max: 2, step: 0.01 },
  'flow.speed': { min: 0, max: 2, step: 0.01 },
  'flow.ribbonWidth': { min: 0.5, max: 128, step: 0.5 },
  'flow.stretch': { min: 0, max: 8, step: 0.05 },
  'flow.density': { min: 0, max: 4, step: 0.01 },
  'flow.trail': { min: 0, max: 1, step: 0.01 },
  'flow.contrast': { min: 0.1, max: 4, step: 0.01 },
  'flow.flowOpacity': { min: 0, max: 1, step: 0.01 },
  'flow.particleOpacity': { min: 0, max: 1, step: 0.01 },
  'flow.particleSize': { min: 0.25, max: 2, step: 0.01 },
  ...
  'noise.causticsDepth': { min: 0.05, max: 3, step: 0.01 },
  'noise.causticsRefraction': { min: 0, max: 1, step: 0.01 },
  'noise.causticsSharpness': { min: 0.5, max: 8, step: 0.05 },
  'noise.causticsComplexity': { min: 2, max: 8, step: 1, integer: true },
  'noise.causticsWaveSpread': { min: 0, max: 1, step: 0.01 },
  'noise.causticsBoundaryWidth': { min: 0.05, max: 1, step: 0.01 },
  'noise.phasorFrequency': { min: 0.5, max: 20, step: 0.05 },
  'noise.phasorBandwidth': { min: 0.1, max: 2, step: 0.01 },
  'noise.phasorDirection': { min: 0, max: 360, step: 1, angleUnit: 'degrees', wrapAngle: true },
  'noise.phasorDirectionSpread': { min: 0, max: 1, step: 0.01 },
  'noise.phasorSharpness': { min: 0.5, max: 10, step: 0.05 },
  'noise.phasorWarpStrength': { min: 0, max: 1, step: 0.01 },
  'noise.phasorTangentMix': { min: 0, max: 1, step: 0.01 },
  'noise.phasorKernelDensity': { min: 0.25, max: 2, step: 0.01 },
