...
const RAW_CONTROL_PARAMETER_DEFINITIONS: readonly ParameterDefinition[] = [
  ...
  enumParameter('postprocess.glassTilePattern', 'postprocess', 'glassTilePattern', ['square', 'diamond', 'hexagon', 'triangle', 'brick', 'faceted'], 'GlassTile surface pattern'),
  numberParameter('postprocess.glassTileFacetDensity', 'postprocess', 'glassTileFacetDensity', 'GlassTile Faceted lattice density'),
  numberParameter('postprocess.glassTileFacetDepth', 'postprocess', 'glassTileFacetDepth', 'GlassTile Faceted relief depth'),
