...
const RAW_CONTROL_PARAMETER_DEFINITIONS: readonly ParameterDefinition[] = [
  ...
  numberParameter('postprocess.glassTileSize', 'postprocess', 'glassTileSize', 4, 4096, 1, 'GlassTile size in pixels', { integer: true }),
  numberParameter('postprocess.glassTileBevel', 'postprocess', 'glassTileBevel', 0.01, 0.5, 0.01, 'GlassTile bevel fraction'),
  numberParameter('postprocess.glassTileSurfaceHeight', 'postprocess', 'glassTileSurfaceHeight', 0, 1, 0.01, 'GlassTile surface height'),
  numberParameter('postprocess.glassTileCurvature', 'postprocess', 'glassTileCurvature', 0, 1, 0.01, 'GlassTile curvature'),
  numberParameter('postprocess.glassTileRefraction', 'postprocess', 'glassTileRefraction', 0, 256, 0.5, 'GlassTile refraction in pixels'),
  numberParameter('postprocess.glassTileDispersion', 'postprocess', 'glassTileDispersion', 0, 1, 0.01, 'GlassTile chromatic dispersion'),
  numberParameter('postprocess.glassTileRoughness', 'postprocess', 'glassTileRoughness', 0, 1, 0.01, 'GlassTile surface detail roughness'),
  numberParameter('postprocess.glassTileDetailScale', 'postprocess', 'glassTileDetailScale', 0.1, 16, 0.1, 'GlassTile detail scale'),
  numberParameter('postprocess.glassTileRotation', 'postprocess', 'glassTileRotation', -180, 180, 1, 'GlassTile rotation in degrees'),
  numberParameter('postprocess.glassTileMix', 'postprocess', 'glassTileMix', 0, 1, 0.01, 'GlassTile effect mix'),
  enumParameter('postprocess.glassTileEdgeMode', 'postprocess', 'glassTileEdgeMode', ['clamp', 'tile', 'mirror', 'transparent'], 'GlassTile source edge mode'),
  numberParameter('postprocess.glassTileSeed', 'postprocess', 'glassTileSeed', 0, 1000000, 1, 'GlassTile surface seed', { integer: true }),
