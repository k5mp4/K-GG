...
const operationDefinitions: readonly ControlOperationDefinition[] = [
  ...
  {
    id: 'set_bezier_control',
    title: 'Set Bezier Control',
    description: 'Move one control point of the Bezier gradient curve axis.',
    group: 'gradient',
    kind: 'mutation',
    inputSchema: objectSchema({
      index: numberSchema(0, 1),
  ...
  {
    id: 'set_mesh_grid_size',
    title: 'Set Mesh Grid Size',
    description: 'Resize the Mesh Gradient vertex grid (rows x columns of grid points, 2..8).',
    group: 'gradient',
    kind: 'mutation',
    inputSchema: objectSchema({
      rows: numberSchema(2, 8),
      columns: numberSchema(2, 8),
    }, ['rows', 'columns']),
    scenarioSafe: true,
    requiresApproval: false,
    requiresNativeCapability: false,
  ...
  {
    id: 'set_mesh_grid_point',
    title: 'Set Mesh Grid Point',
    description: 'Move one Mesh Gradient grid point by row-major index.',
    group: 'gradient',
    kind: 'mutation',
    inputSchema: objectSchema({
      index: numberSchema(0, 63),
      position: vectorSchema,
    }, ['index', 'position']),
    scenarioSafe: true,
    requiresApproval: false,
  ...
  {
    id: 'set_mesh_color_mode',
    title: 'Set Mesh Color Mode',
    description: 'Switch the Mesh Gradient color source between ramp-driven and per-point direct colors.',
    group: 'gradient',
    kind: 'mutation',
    inputSchema: objectSchema({
      mode: { type: 'string', enum: ['ramp', 'direct'] },
    }, ['mode']),
    scenarioSafe: true,
    requiresApproval: false,
    requiresNativeCapability: false,
  ...
  {
    id: 'set_mesh_grid_point_color',
    title: 'Set Mesh Grid Point Color',
    description: 'Set the direct hex color of one Mesh Gradient grid point by row-major index (direct color mode).',
    group: 'gradient',
    kind: 'mutation',
    inputSchema: objectSchema({
      index: numberSchema(0, 63),
