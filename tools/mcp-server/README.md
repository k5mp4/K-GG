...
接続後は `kgg_list_controls` で、Gradient、Noise、Diffuse、Image Gradient、Slit Scan、Stretch、Animation、Normal Map、Cloth、Cone、Seamless、Flow、Manual Distort、Postprocess、Effect Pipeline、Histogram、Keyframe、UIの操作groupと、安全境界付きoperationを確認できます。
