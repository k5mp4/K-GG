...
const uiTerms = [
  ['Amount', '量'], ['Anchor Influence', 'アンカー影響'], ['Angle', '角度'], ['Band Height', '帯の高さ'],
  ...
  ['Edge', 'エッジ'], ['Edge Fade', 'エッジ減衰'], ['Emitter Type', '放出方式'], ['Evolution', '展開'],
  ...
  ['Ray Count', '光線数'], ['Refraction', '屈折'], ['Rot Angle 1', '回転角 1'], ['Rot Angle 2', '回転角 2'],
  ['Rotation', '回転'], ['Roughness', '粗さ'], ['Scale', 'スケール'], ['Scan Position', '走査位置'],
  ['Scatter', '拡散量'], ['Seamless Animation', 'シームレスアニメーション'], ['Seamless Base', 'シームレス基準'],
  ['Seed', 'シード'], ['Sharpness', '鋭さ'], ['Sides', '辺数'], ['Size', 'サイズ'],
