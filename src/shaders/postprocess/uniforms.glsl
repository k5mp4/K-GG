...
uniform float u_glassTileCurvature;
uniform float u_glassTileRefraction;
uniform float u_glassTileDispersion;
uniform float u_glassTileRoughness;
uniform float u_glassTileDetailScale;
uniform float u_glassTileRotation;
uniform float u_glassTileMix;
uniform int u_glassTileEdgeMode;
uniform float u_glassTileSeed;
...
uniform int u_diffuseHalftoneShape;
