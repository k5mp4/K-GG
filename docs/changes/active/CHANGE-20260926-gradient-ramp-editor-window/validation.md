...
| AC-002 | unit / Tauri manual | `src/adapters/tauri/toolWindows.test.ts`、両ウインドウで相互に編集 | unit pass / manual pass: 初回実装は反映に大きな遅れ（イベント滞留）→ ACK流量制御を追加し、利用者確認で解消（2026-09-26） |
